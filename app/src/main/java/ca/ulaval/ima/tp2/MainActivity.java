...
import ca.InternetFragment;
import ca.AboutFragment;
import ca.ProfilFragment;
...
//NOTE: creating fragment object
        ...
        if (id == R.id.nav_fragment_internet) {
            fragment = new InternetFragment();
        } else if (id == R.id.nav_fragment_about) {
            fragment = new AboutFragment();
        }else if (id == R.id.nav_fragment_profil) {
